  ...
  function clickHandler(e) {
    ...
    if (bdayString !== '') {
      ...
      if (!isPalindrome) {
        ...
        if (ctr1 > ctr2) {
          outputMsg.innerText = `The nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} days.`;
        } else {
          outputMsg.innerText = `The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} days.`;
        }
  
      } else {
        outputMsg.innerText = 'Yay! Your birthday is palindrome!';
      }
    }
  }
